...
Game.WEAPONS = {
    ...
    pistol_pl: {
        name: 'Vis wz. 35', nation: 'polish', type: 'pistol', fireType: 'single',
        crew: 1, gameRange: 10, rateOfFire: 1.2, cooldown: 0.8,
        accuracy: { close: 0.48, medium: 0.20, long: 0.06 },
        damage: 10, suppression: 2, penetration: 0, heBlast: 0,
    },
    ...
    kbk_wz29: {
        ...
        rateOfFire: 0.27,
        cooldown: 3.7,
        accuracy: { close: 0.54, medium: 0.69, long: 0.64 },
        damage: 24,
        suppression: 5,
        penetration: 0,
        heBlast: 0,
    ...
    browning_wz28: {
        ...
        rateOfFire: 4.1,
        cooldown: 0.24,
        accuracy: { close: 0.54, medium: 0.50, long: 0.37 },
        damage: 10,
        suppression: 12,
        penetration: 1,
        heBlast: 0,
    ...
    ckm_wz30: {
        ...
        rateOfFire: 5.2,
        cooldown: 0.19,
        accuracy: { close: 0.57, medium: 0.54, long: 0.44 },
        damage: 10,
        suppression: 17,
        penetration: 1,
        heBlast: 0,
    ...
    grenade_launcher_46mm: {
        name: 'Granatnik wz. 36 (46mm)',
        nation: 'polish',
        type: 'mortar',
        fireType: 'indirect',
        crew: 2,
        ...
        rateOfFire: 0.6,
        cooldown: 1.65,
        accuracy: { close: 0.67, medium: 0.53, long: 0.39 },
        damage: 20,
        suppression: 14,
        penetration: 0,
        heBlast: 3.0,
    ...
    mortar_81mm_pl: {
        ...
        rateOfFire: 0.33,
        cooldown: 3.0,
        accuracy: { close: 0.59, medium: 0.49, long: 0.35 },
        damage: 37,
        suppression: 21,
        penetration: 2,
        heBlast: 5.0,
    ...
    wz35_at_rifle: {
        name: 'Karabin przeciwpancerny wz. 35 Ur',
        nation: 'polish',
        type: 'at_rifle',
        fireType: 'single',
        crew: 2,
        ...
        rateOfFire: 0.42,
        cooldown: 2.4,
        accuracy: { close: 0.72, medium: 0.60, long: 0.38 },
        damage: 22,
        suppression: 5,
        penetration: { close: 33, medium: 24, long: 12 },
        heBlast: 0,
    },
    ...
    bofors_37mm_wz36: {
        name: '37mm armata ppanc. wz. 36 Bofors',
        nation: 'polish',
        type: 'atgun',
        fireType: 'single',
        crew: 5,
        ...
        rateOfFire: 0.55,
        cooldown: 1.8,
        accuracy: { close: 0.75, medium: 0.67, long: 0.52 },
        damage: 46,
        suppression: 7,
        penetration: { close: 42, medium: 36, long: 29 },
        heBlast: 0.8,
        setupTime: 4.0,
        teardownTime: 3.5,
    },
    wz1902_26_75mm: {
        name: '75mm armata wz. 1902/26',
        nation: 'polish',
        type: 'fieldgun',
        fireType: 'indirect',
        crew: 6,
        ...
        rateOfFire: 0.25,
        cooldown: 4.0,
        accuracy: { close: 0.60, medium: 0.49, long: 0.34 },
        damage: 48,
        suppression: 24,
        penetration: { close: 28, medium: 22, long: 16 },
        heBlast: 5.2,
        setupTime: 6.0,
        teardownTime: 5.0,
    },
    ...
    ckm_wz30_vehicle: {
        ...
        rateOfFire: 4.8,
        cooldown: 0.2,
        accuracy: { close: 0.54, medium: 0.46, long: 0.32 },
        damage: 10,
        suppression: 12,
        penetration: 1,
        heBlast: 0,
